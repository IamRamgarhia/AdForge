...
export const openai: Provider = {
  ...
  models: [
    { id: "gpt-5", label: "GPT-5 — flagship", pricing: { input_per_million_usd: 1.25, output_per_million_usd: 10 }, best_for: "Top-tier reasoning + JSON correctness" },
    { id: "gpt-5-mini", label: "GPT-5 mini", pricing: { input_per_million_usd: 0.25, output_per_million_usd: 2 }, best_for: "Default cost/quality balance" },
    { id: "gpt-4.1", label: "GPT-4.1 — proven", pricing: { input_per_million_usd: 2, output_per_million_usd: 8 } },
    { id: "gpt-4.1-mini", label: "GPT-4.1 mini — cheap fast", pricing: { input_per_million_usd: 0.4, output_per_million_usd: 1.6 } },
  ],
...
export const openrouter: Provider = {
  ...
  models: [
    ...
    { id: "google/gemini-2.5-flash", label: "Gemini 2.5 Flash", pricing: { input_per_million_usd: 0.3, output_per_million_usd: 2.5 } },
    { id: "anthropic/claude-sonnet-4-6", label: "Claude Sonnet 4.6", pricing: { input_per_million_usd: 3, output_per_million_usd: 15 } },
    { id: "openai/gpt-4.1-mini", label: "GPT-4.1 mini", pricing: { input_per_million_usd: 0.4, output_per_million_usd: 1.6 } },
  ],
